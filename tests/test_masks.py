...
@pytest.mark.parametrize(
    "number_card, expected", [("1234567890123456", "1234 56** **** 3456"), ("4567456745674567", "4567 45** **** 4567")]
)
...
@pytest.mark.parametrize("account, expected", [("12345678901234567890", "**7890"), ("45674567456745674567", "**4567")])
def test_get_mask_account(account, expected):
    assert get_mask_account(account) == expected


@pytest.mark.parametrize(
    "account_wrong, expected",
    [
...
def test_get_mask_account_wrong(account_wrong, expected):
