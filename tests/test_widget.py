...
@pytest.mark.parametrize('number_card_or_account_wrong, expected',[
...
@pytest.mark.parametrize('date, expected',[
    ('2024-03-11T03:26:18.671407', '11.03.2024'),
    ('2024-05-15T02:56:18.671407', '15.05.2024')
])

def test_get_date(date, expected):
    assert get_date(date) == expected

@pytest.mark.parametrize('date_wrong, expected',[
    ('', 'Неверный ввод даты'),
    ('06.12.2001', 'Неверный ввод даты')
])

def test_get_date(date_wrong, expected):
